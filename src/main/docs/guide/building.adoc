...
Step 1/8 : FROM eclipse-temurin:11-jdk-alpine
---> 3642e636096d
Step 2/8 : LABEL maintainer="John Doe john.doe@example.com"
---> Using cache
---> 3e1c67b067e8
Step 3/8 : EXPOSE 8080
---> Using cache
---> 144aadd0580e
Step 4/8 : WORKDIR /home/app
---> Using cache
---> c9af01e696f8
...
Step 8/8 : ENTRYPOINT ["/home/app/app-entrypoint.sh"]
...
grails-sample/complete         0.1                 68f5588d1134        3 minutes ago       424MB
----
